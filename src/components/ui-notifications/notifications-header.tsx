...
import { Bell, Filter, X, Clock, AlertTriangle } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
interface NotificationsHeaderProps {
  ...
  activeView?: 'upcoming' | 'overdue';
  onViewChange?: (view: 'upcoming' | 'overdue') => void;
  overdueCount?: number;
}
    ...
    <div className="bg-white border-b border-gray-200">
      <div className="px-4 md:px-6 py-4">
        <div className="flex flex-col gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {notificationCount > 0 && (
                    <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 border-blue-200 border">
                      {notificationCount} {notificationCount === 1 ? 'tarea' : 'tareas'}
                    </Badge>
                  )}
                  {hasActiveFilters && (
                    <Button
                ...
                <p className="text-sm text-gray-500 mt-0.5">
                  {activeView === 'upcoming' 
                    ...
                    : 'Tareas que ya han superado su fecha de vencimiento'
                  }
                </p>
              </div>
            </div>
          ...
          <Tabs value={activeView} onValueChange={(value) => onViewChange?.(value as 'upcoming' | 'overdue')} className="w-full">
